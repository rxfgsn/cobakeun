...
model_path = 'C:\\Users\\tab3v\\Downloads'
...
ChestPainType = st.selectbox("Chest Pain Type", ["ASY", "ATA", "NAO", "TA"])
RestingBP = st.number_input("Resting Blood Pressure",0,200)
Cholestrol = st.number_input("Cholestrol", 0,603)
...
Old_peak = st.slider("Old_peak",-3.0,7.0,step=0.1)
...
input_data = [[input_sex_F,input_sex_M,input_cpain_ASY,
               input_cpain_ATA,iniput_cpain_NAP,input_cpain_TA,
               input_restecg_LVH,input_restecg_NORMAL,input_restecg_ST,
               input_anginaN,input_anginaY,input_STslope_down,
               input_STslope_flat,input_STslope_up,Age,RestingBP,Cholestrol,input_fastbs,MaxHR,Old_peak]]
